...
Shader "SyntyStudios/TreesScriptable"
{
	Properties
	{
		_Emission("Emission", 2D) = "white" {}
		_MainTex("_MainTexture", 2D) = "white" {}
		[PerRendererData] _ColorTint("_ColorTint", Color) = (0,0,0,0)
		[PerRendererData] _EmissionColor("EmissionColor", Color) = (0,0,0,0)
